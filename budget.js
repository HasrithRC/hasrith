function budget() {
    const list = document.getElementById('budgetDestList');
    ...
    initCustomSelect('budgetDestWrapper', 'budgetDest', function () {
        showErr('errDest', false);
    });
    renderSavedTrips();
}
...
function showErr(id, show) {
    ...
    if (inp && inp.type === 'hidden') inp = inp.previousElementSibling;
...
function resetBudget() {
    ...
    document.getElementById('budgetDest').value = '';
    resetCustomSelect('budgetDestWrapper', 'Select a destination...');
